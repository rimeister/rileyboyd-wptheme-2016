...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<h1 class="page-header-title">Creations</h1>
		...
		<main id="main" class="site-main <?php echo "page-".$paged;?>" role="main">				
			...
			<div class="article-container">
						...
						<div class="blog-item-wrap">
							<div class="post-inner-content">
						       ...
						       ?>
								...
								<div class="read-more">
									<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'See More', 'activello' ); ?></a>
								</div>		
				...
				?>
					...
					<h2>I haven't posted any creations yet. Sorry about that!</h2>
